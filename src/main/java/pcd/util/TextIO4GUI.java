...
/**
 * TextIO provides a set of  methods for reading and writing text.  This version of TextIO
 ...
 * everything is in a single source file, all the methods are  methods, and none of the methods throw
...
public class TextIO4GUI {
    ...
    private final Console console;  // The GUI IO widget used for simulated input/output.
